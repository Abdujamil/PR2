	...
	_In_ int nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_PR2, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PR2));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PR2));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_PR2);
...
// маркер экземпляра сохраняется в глобальной переменной, а также
...
// WndProc(HWND, UINT, WPARAM, LPARAM) - брабатывает сообщения в главном окне.
